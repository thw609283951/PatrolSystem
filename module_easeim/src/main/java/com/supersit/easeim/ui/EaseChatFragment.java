...
//    protected static final int REQUEST_CODE_CAMERA = 2;
    ...
    protected String currCameraImgPath;
...
//        messageList.setAvatarShape(1);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK) { 
            if (requestCode == Constant.CODE_CAMERA_REQUEST) { // capture new image
                if (new File(currCameraImgPath).exists())
                    sendImageMessage(currCameraImgPath);
            ...
            } else if (requestCode == Constant.CODE_LOCATION_REQUEST) { // location
...
//                startActivityForResult(new Intent(getActivity(), EaseBaiduMapActivity.class), REQUEST_CODE_MAP);
                AndPermission.with(mContext)
                        ...
                        .onGranted(data -> {
                            LocationCorrectionActivity.start(getActivity());
                        }).onDenied(data -> {
                    Toasty.error(mContext,mContext.getString(R.string.lack_of_permissions)).show();
                }).start();
                break;
    ...
    protected void selectPicFromCamera() {
        ...
        ActionUtil.openCamera(mContext,currCameraImgPath);
    }
...
//        }
        GroupDetailsActivity.start(mContext,toChatUsername);
