...
import com.supersit.easeim.BuildConfig;
import com.supersit.easeim.R;
import com.supersit.easeim.entity.VideoEntity;
import com.supersit.common.utils.video.ImageCache;
import com.supersit.common.utils.video.ImageResizer;
import com.supersit.common.utils.video.Utils;
import com.supersit.easeim.wiget.RecyclingImageView;
...
public class ImageGridFragment extends Fragment implements OnItemClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mImageResizer.setLoadingImage(R.mipmap.ic_empty_photo);
	...
	private class ImageAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup container) {
			 ...
			 if(convertView==null)
			 {
				 ...
				 convertView= LayoutInflater.from(mContext).inflate(R.layout.item_choose, container,false);
			...
			if(position==0)
			{
				...
				holder.imageView.setImageResource(R.mipmap.ic_actionbar_camera);
			}else{
				...
				holder.imageView.setImageResource(R.mipmap.ic_empty_photo);
