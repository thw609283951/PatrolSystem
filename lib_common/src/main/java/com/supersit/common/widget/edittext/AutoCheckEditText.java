...
public class AutoCheckEditText extends AppCompatEditText implements TextWatcher, View.OnFocusChangeListener {
...
//            if(EditTextType.TYPE_OF_NOT_EMPTY == mType)

            changeWarnStatus(EditTextType.TYPE_OF_NOT_EMPTY == mType, mWarningMsg.getMsg());
        }
    }
