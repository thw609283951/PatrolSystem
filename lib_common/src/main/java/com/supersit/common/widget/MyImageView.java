...
public class MyImageView extends AppCompatImageView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            borderColor = array.getColor(R.styleable.MyImageView_border_color, borderColor);
            borderWidth = array.getDimensionPixelOffset(R.styleable.MyImageView_border_width, borderWidth);
            pressAlpha = array.getInteger(R.styleable.MyImageView_press_alpha, pressAlpha);
            pressColor = array.getColor(R.styleable.MyImageView_press_color, pressColor);
            radius = array.getDimensionPixelOffset(R.styleable.MyImageView_radius, radius);
            shapeType = array.getInteger(R.styleable.MyImageView_shape_type, shapeType);
            array.recycle();
        }
