...
//        appendLine().setFontSize(0);// it's important for span start with icon
     ...
     *             </ul>
     * @return {@link SpannableStringUtil}
     */
    public SpannableStringUtil setFlag(final int flag) {
        this.flag = flag;
        return this;
    }
     ...
     * @return {@link SpannableStringUtil}
     */
    public SpannableStringUtil setForegroundColor(@ColorInt final int color) {
     ...
     * @return {@link SpannableStringUtil}
     */
    public SpannableStringUtil setBackgroundColor(@ColorInt final int color) {
     ...
     * @return {@link SpannableStringUtil}
     */
    public SpannableStringUtil setLineHeight(@IntRange(from = 0) final int lineHeight) {
     ...
     * @return {@link SpannableStringUtil}
     */
    public SpannableStringUtil setQuoteColor(@ColorInt final int color) {
     ...
     * @return {@link SpannableStringUtil}
     */
    public SpannableStringUtil setLeadingMargin(@IntRange(from = 0) final int first,
     ...
     * @return {@link SpannableStringUtil}
     */
    public SpannableStringUtil setBullet(@IntRange(from = 0) final int gapWidth) {
     ...
     * @return {@link SpannableStringUtil}
     */
    public SpannableStringUtil setBullet(@ColorInt final int color,
     ...
     * @return {@link SpannableStringUtil}
     */
    public SpannableStringUtil setIconMargin(final Bitmap bitmap) {
     ...
     * @return {@link SpannableStringUtil}
     */
    public SpannableStringUtil setIconMargin(final Drawable drawable) {
     ...
     * @return {@link SpannableStringUtil}
     */
    public SpannableStringUtil setIconMargin(final Uri uri) {
     ...
     * @return {@link SpannableStringUtil}
     */
    public SpannableStringUtil setIconMargin(final Uri uri, final int gapWidth, @Align final int align) {
        this.imUri = uri;
        this.imGapWidth = gapWidth;
        this.imAlign = align;
        return this;
     ...
     * @return {@link SpannableStringUtil}
     */
    public SpannableStringUtil setIconMargin(@DrawableRes final int resourceId) {
     ...
     * @return {@link SpannableStringUtil}
     */
    public SpannableStringUtil setFontSize(@IntRange(from = 0) final int size) {
     ...
     * @return {@link SpannableStringUtil}
     */
    public SpannableStringUtil setFontSize(@IntRange(from = 0) final int size, final boolean isDp) {
        this.fontSize = size;
     ...
     * @return {@link SpannableStringUtil}
     */
    public SpannableStringUtil setFontProportion(final float proportion) {
     ...
     * @return {@link SpannableStringUtil}
     */
    public SpannableStringUtil setFontXProportion(final float proportion) {
     ...
     * @return {@link SpannableStringUtil}
     */
    public SpannableStringUtil setStrikethrough() {
     ...
     * @return {@link SpannableStringUtil}
     */
    public SpannableStringUtil setUnderline() {
     ...
     * @return {@link SpannableStringUtil}
     */
    public SpannableStringUtil setSuperscript() {
     ...
     * @return {@link SpannableStringUtil}
     */
    public SpannableStringUtil setSubscript() {
     ...
     * @return {@link SpannableStringUtil}
     */
    public SpannableStringUtil setBold() {
        isBold = true;
        return this;
    }
     ...
     * @return {@link SpannableStringUtil}
     */
    public SpannableStringUtil setItalic() {
        isItalic = true;
        return this;
    }
     ...
     * @return {@link SpannableStringUtil}
     */
    public SpannableStringUtil setBoldItalic() {
        isBoldItalic = true;
        return this;
    }
     ...
     * @return {@link SpannableStringUtil}
     */
    public SpannableStringUtil setFontFamily(@NonNull final String fontFamily) {
     ...
     * @return {@link SpannableStringUtil}
     */
    public SpannableStringUtil setTypeface(@NonNull final Typeface typeface) {
     ...
     * @return {@link SpannableStringUtil}
     */
    public SpannableStringUtil setAlign(@NonNull final Alignment alignment) {
     ...
     * @return {@link SpannableStringUtil}
     */
    public SpannableStringUtil setClickSpan(@NonNull final ClickableSpan clickSpan) {
     ...
     * @return {@link SpannableStringUtil}
     */
    public SpannableStringUtil setUrl(@NonNull final String url) {
        this.url = url;
        return this;
    }
     ...
     * @return {@link SpannableStringUtil}
     */
    public SpannableStringUtil setBlur(@FloatRange(from = 0, fromInclusive = false) final float radius,
                             final Blur style) {
     ...
     * @return {@link SpannableStringUtil}
     */
    public SpannableStringUtil setShader(@NonNull final Shader shader) {
        this.shader = shader;
        return this;
    }
     ...
     * @return {@link SpannableStringUtil}
     */
    public SpannableStringUtil setShadow(@FloatRange(from = 0, fromInclusive = false) final float radius,
                               final float dx,
                               final float dy,
     ...
     * @return {@link SpannableStringUtil}
     */
    public SpannableStringUtil setSpans(@NonNull final Object... spans) {
        if (spans.length > 0) {
            this.spans = spans;
        }
        return this;
     ...
     * @return {@link SpannableStringUtil}
     */
    public SpannableStringUtil append(@NonNull final CharSequence text) {
     ...
     * @return {@link SpannableStringUtil}
     */
    public SpannableStringUtil appendLine() {
        apply(mTypeCharSequence);
     ...
     * @return {@link SpannableStringUtil}
     */
    public SpannableStringUtil appendLine(@NonNull final CharSequence text) {
        apply(mTypeCharSequence);
     ...
     * @return {@link SpannableStringUtil}
     */
    public SpannableStringUtil appendImage(@NonNull final Bitmap bitmap) {
     ...
     * @return {@link SpannableStringUtil}
     */
    public SpannableStringUtil appendImage(@NonNull final Bitmap bitmap, @Align final int align) {
        apply(mTypeImage);
     ...
     * @return {@link SpannableStringUtil}
     */
    public SpannableStringUtil appendImage(@NonNull final Drawable drawable) {
     ...
     * @return {@link SpannableStringUtil}
     */
    public SpannableStringUtil appendImage(@NonNull final Drawable drawable, @Align final int align) {
        apply(mTypeImage);
     ...
     * @return {@link SpannableStringUtil}
     */
    public SpannableStringUtil appendImage(@NonNull final Uri uri) {
     ...
     * @return {@link SpannableStringUtil}
     */
    public SpannableStringUtil appendImage(@NonNull final Uri uri, @Align final int align) {
        apply(mTypeImage);
        this.imageUri = uri;
        this.alignImage = align;
        return this;
     ...
     * @return {@link SpannableStringUtil}
     */
    public SpannableStringUtil appendImage(@DrawableRes final int resourceId) {
     ...
     * @return {@link SpannableStringUtil}
     */
    public SpannableStringUtil appendImage(@DrawableRes final int resourceId, @Align final int align) {
     ...
     * @return {@link SpannableStringUtil}
     */
    public SpannableStringUtil appendSpace(@IntRange(from = 0) final int size) {
     ...
     * @return {@link SpannableStringUtil}
     */
    public SpannableStringUtil appendSpace(@IntRange(from = 0) final int size, @ColorInt final int color) {
        apply(mTypeSpace);
        spaceSize = size;
        spaceColor = color;
        return this;
